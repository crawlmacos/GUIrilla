...
MODEL_ID = "Qwen/Qwen2.5-VL-3B-Instruct"  # checkpoint name on HF Hub
OUTPUT_DIR = Path("qwen2_5_vl_3b_guirilla_lora")
WANDB_PROJECT = "qwen2_5_vl_3b_guirilla"
...
TRAIN_ARGS = dict(
    ...
    warmup_ratio=0.05,
    push_to_hub=True,
    hub_model_id="GUIrilla/GUIrilla-See-3B",
...
def format_sample(sample: Dict[str, Any]) -> Dict[str, Any]:
    ...
    image, bbox = resize_image_bbox_qwen25(image, bbox) #, 28 * 28 * 16, 28 * 28 * 576)
